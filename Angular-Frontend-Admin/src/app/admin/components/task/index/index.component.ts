...
export class TaskIndexComponent extends MagpieIndexComponent {
  @Input()
  section_data: any;
  section_config: any;
  columns: any = "";
  ...
  ngOnInit() {
    ...
    this.module_id = Number(this.route.snapshot.paramMap.get('id'));
    ...
    swal({
      ...
      if (isConfirm) {
        if (th.delete_action) {
          ...
          th.webSocketService.deleteItem({ module: this.section_alias, room: 1 });
        }
      }
    });
  }
    ...
    this.section_service.getCurrentRolePermissionMenus('roles', localStorage.getItem("userDetails['roles_id']")).subscribe(res1 => {
      ...
      if (menus_actions['Import']) {
        this.subsectionService.sectionConfig(this.current_section).subscribe(res => {
          ...
          this.route.params.subscribe(params => {
            this.section_service.import(this.file_import, columns_array, import_unique_field, '/admin/module').subscribe(result => {
              if (import_csv_data) {
                this.index();
  ...
  onSortClick = (sortable, field, i) => {
    ...
    if (sortable == 'true') {
      ...
      this.route.params.subscribe(params => {
        this.subsectionService.search(this.search_word, this.searchable_fields, order_by, field, this.column_relation, this.current_page, this.per_page, this.current_section,{'module':this.module_id}).subscribe(result => {
  ...
  onPerpageChange = (perPage) => {
    ...
    this.route.params.subscribe(params => {
      this.section_service.search(this.search_word, this.searchable_fields, this.order_fieldBy, this.order_field, this.column_relation, this.current_page, this.per_page, '/admin/module').subscribe(result => {
        this.section_data = result['data'];
        this.pages = result['pages'];
        this.current = result['current'];
        this.paginate_total = result['tot'];
  ...
  onPaginateClick = (page) => {
    this.spinnerService.show();
    this.route.params.subscribe(params => {
      this.section_service.search(this.search_word, this.searchable_fields, this.order_fieldBy, this.order_field, this.column_relation, page, this.per_page, '/admin/module').subscribe(result => {
        this.section_data = result['data'];
        this.pages = result['pages'];
        this.current = result['current'];
        this.paginate_total = result['tot'];
  ...
  onSearchChange = (value) => {
    ...
    this.spinnerService.show();
    this.route.params.subscribe(params => {
      this.section_service.search(value, this.searchable_fields, this.order_fieldBy, this.order_field, this.column_relation, this.current_page, this.per_page, '/admin/module').subscribe(result => {
        this.section_data = result['data'];
        this.pages = result['pages'];
        this.current = result['current'];
        this.paginate_total = result['tot'];
    ...
    this.section_service.getCurrentRolePermissionMenus('roles', localStorage.getItem("userDetails['roles_id']")).subscribe(res1 => {
      ...
      if (menus_actions['Index']) {
        this.subsectionService.sectionConfig(this.current_section).subscribe(res => {
          ...
          this.subsectionService.get(this.current_page, this.per_page, this.order_field, this.order_fieldBy, 'task',{'module':this.module_id}).subscribe(result => {
            this.section_data = result['data'];
